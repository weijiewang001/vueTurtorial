  ...
  <main>
    ...
    <div class="container mx-auto flex items-center">
      <button type="button" class="z-50 h-24 w-24 text-3xl bg-white text-black rounded-full
        focus:outline-none" @click.prevent = "toggleAudioSong(song)">
        <i class="fas" :class="{'fa-play':!playingP, 'fa-pause':playingP}"></i>
      </button>
...
export default {
    ...
    methods: {
        ...mapActions(['newSong','toggleAudioSong']),
